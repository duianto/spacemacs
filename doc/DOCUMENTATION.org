...
- [[#commands][Commands]]
  ...
  - [[#navigating][Navigating]]
    ...
    - [[#tabs][Tabs]]
      - [[#tabs-transient-state][Tabs Transient State]]
    - [[#ido][Ido]]
...
*** Tabs
Tabs visibility can be toggled on and off with: ~SPC t t~

**** Tabs Transient State
Opening the Tabs Transient State shows the tabs if they are hidden.

| Key binding | Description                   |
|-------------+-------------------------------|
| ~SPC t .~   | Open the Tabs Transient State |
| ~j~         | Backward tab                  |
| ~k~         | Forward tab                   |
| ~h~         | Backward group                |
| ~l~         | Forward group                 |
| ~g~         | Select group                  |
| ~q~         | Quit the Tabs Transient State |
